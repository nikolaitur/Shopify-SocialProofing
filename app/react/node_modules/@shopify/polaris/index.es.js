import { Children, Component, PropTypes, PureComponent, createElement } from 'react';
...
var UnstyledLink$1 = function (_React$PureComponent) {
    ...
    _createClass(UnstyledLink, [{
        ...
        value: function render() {
            if (LinkComponent) {
                return createElement(LinkComponent, Object.assign({}, this.props, unstyled.props));
            }
            var _a = this.props,
...
var criticalIcon = {"viewBox":"0 0 20 20","body":"<defs><path d=\"M10 0C4.486 0 0 4.486 0 10s4.486 10 10 10 10-4.486 10-10S15.514 0 10 0zm0 2.5c1.617 0 3.113.52 4.34 1.394L3.893 14.34A7.467 7.467 0 0 1 2.5 10c0-4.136 3.364-7.5 7.5-7.5zm0 15a7.459 7.459 0 0 1-4.34-1.394L16.107 5.66A7.472 7.472 0 0 1 17.5 10c0 4.136-3.364 7.5-7.5 7.5z\" id=\"a\"/></defs><g  fill-rule=\"evenodd\"><circle fill=\"currentColor\" cx=\"10\" cy=\"10\" r=\"9\"/><use  fill-rule=\"nonzero\" xlink:href=\"#a\"/></g>"};
...
function Banner$1(_ref) {
    ...
    var dismissButton = onDismiss ? createElement(
        ...
        createElement(Button$1, { plain: true, icon: 'cancelSmall', accessibilityLabel: 'Dismiss notification' })
    ) : null;
    return createElement(
        'div',
...
var TooltipOverlay = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderOverlay() {
            ...
            return createElement(PositionedOverlay$1, { active: active, activator: activator, preferredPosition: preferredPosition, render: this.renderTooltip.bind(this) });
        }
    }, {
        key: 'renderTooltip',
